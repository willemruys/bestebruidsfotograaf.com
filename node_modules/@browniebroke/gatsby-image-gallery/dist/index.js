  ...
  _createClass(ReactImageLightbox, [{
    ...
    value: function calculatePinchCenter() {
      var _ref10 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.pinchTouchList,
          _ref11 = _slicedToArray$1(_ref10, 2),
          a = _ref11[0],
          b = _ref11[1];
...
var Col = styled__default.div(_templateObject$1(), function (props) {
  return styled.css(_templateObject2(), props.width, props.width);
}, function (props) {
  return styled.css(_templateObject3(), props.md, props.md);
});
Col.propTypes = {
...
var ImgWrapper = styled__default.div(_templateObject$2(), function (props) {
  return props.margin;
});
...
var Gallery = function Gallery(_ref) {
  var _ref$images = _ref.images,
      ...
      _ref$thumbs = _ref.thumbs,
      thumbs = _ref$thumbs === void 0 ? null : _ref$thumbs,
      _ref$fullImages = _ref.fullImages,
      fullImages = _ref$fullImages === void 0 ? null : _ref$fullImages,
  ...
  var thumbsArray, fullArray;

  if (thumbs === null && fullImages === null) {
    // New style with all images in one prop
    thumbsArray = images.map(function (_ref2) {
      var thumb = _ref2.thumb;
      return thumb;
    });
    fullArray = images.map(function (_ref3) {
      var full = _ref3.full;
      return full.src;
    });
  } else {
  ...
  var prevIndex = index - 1 % fullArray.length;
  var nextIndex = (index + fullArray.length + 1) % fullArray.length;
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Row, null, thumbsArray.map(function (thumbnail, thumbIndex) {
    ...
    }, /*#__PURE__*/React__default.createElement(ImgWrapper, {
      margin: gutter
    }, /*#__PURE__*/React__default.createElement(Img, {
      fluid: thumbnail,
      className: imgClass
    })));
  })), isOpen && /*#__PURE__*/React__default.createElement(ReactImageLightbox, {
    ...
    prevLabel: "Image pr\xE9c\xE9dente",
    zoomInLabel: "Zoomer",
